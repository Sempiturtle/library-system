<nav x-data="{ open: false }" class="bg-white/70 backdrop-blur-xl border-b border-gray-200 shadow-md sticky top-0 z-50 font-poppins">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">

            <!-- Left: Logo / Brand -->
            <div class="flex items-center">
                <div class="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400">
                    📚 AISAT Library
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-white/80 backdrop-blur-xl border-t border-gray-200">
