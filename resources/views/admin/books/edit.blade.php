        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white/40 p-8">
            <form action="{{ route('admin.books.update', $book->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="copies" value="{{ old('copies', $book->copies) }}" min="0"
                        class="w-full p-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit"
                        class="px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold shadow-md hover:scale-105 transition">Update Book</button>
                </div>
            </form>
        </div>
    </div>
